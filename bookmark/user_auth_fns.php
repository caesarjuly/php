<?php
	...
	{
		//check uesrname and password with db
		//if yes, return true
		...
		if ($result->num_rows>0) {
			...
			throw new Exception('Cound not log you in');
	...
	{
		//change password for username/old_password to new pass_word
	...
	function get_random_word($min_length, $max_length)
	{
		...
		$dictionary = 'ispell-enwl-3.1.20/english.0';
	...
	function notify_password($username, $password)
	{
		...
		if (!$result) {
			...
			$mesg = "Your PHPBookmark password has been changed to '$password' \r\n Please chang it next time you log in .\r\n";

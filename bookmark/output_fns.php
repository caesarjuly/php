...
<?php
	...
	global $bm_table;
	if ($bm_table == true) {
		echo "<a href=\"#\" onClick=\"bm_table.submit();\">Delete BM</a> &nbsp;|&nbsp";
	}else{
		echo "<span style=\"color: #cccccc\">Delete BM</span> &nbsp;|&nbsp";
	}
?>
...
<?php
	...
	{
		//display the form for the people to create a new bookmark
?>
